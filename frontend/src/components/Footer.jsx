    ...
    <footer className="footer">
      <div className="container flex items-center justify-center">
        <div className="footer-left max-w-screen-xl row d-flex flex-wrap justify-between">
          ...
          <div className="col-md-4 flex flex-col items-center text-center md:text-center">
            ...
            <ul className="social-icons">
              <li>
                <a
                  href="https://www.facebook.com/YourEcommerce"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://www.instagram.com/YourEcommerce"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.twitter.com/YourEcommerce"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div className="copyright text-center mt-6">
          ...
          <p className="copyright-text">
            Disclaimer: All contents, intellectual Properties & Copyrights
            Reserved
          </p>
        </div>
      </div>
